...
Fibonacci sequence by once place, you may be tempted to think that we would
...
function tribonacci(signature, n) {
  let triArray = signature;
  for (i = 3; i < n; i++) {
    triArray.push(triArray[i - 1] + triArray[i - 2] + triArray[i - 3]);
  }
  return triArray.slice(0, n);
}
